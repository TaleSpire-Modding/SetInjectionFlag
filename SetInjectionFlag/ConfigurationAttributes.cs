...
/// Config.AddSetting("X", "1", 1, new ConfigDescription("", null, new ConfigurationAttributes { IsAdvanced = true, Order = 3 }));
/// // Override only Order, IsAdvanced stays as the default value assigned by ConfigManager
/// Config.AddSetting("X", "2", 2, new ConfigDescription("", null, new ConfigurationAttributes { Order = 1 }));
/// Config.AddSetting("X", "3", 3, new ConfigDescription("", null, new ConfigurationAttributes { Order = 2 }));
/// </code>
/// </example>
/// <remarks>
...
namespace PluginUtilities
{
    public sealed class ConfigurationAttributes
    {
        ...
        /// <summary>
        ///     Custom Callback on the event Configuration Manager updates the value.
        /// </summary>
